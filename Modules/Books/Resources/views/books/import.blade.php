...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 ml-3 mb-3">
            <a class="btn btn-sm btn-info" href="/storage/templates/books_import.csv"><i class="fa fa-download"></i> Download Template</a>
        </div>
    </div>

    <div class="row">
        <div class="col-md-12 col-sm-12 ">
            <form class="form" method="POST" action="{{ route('books.import') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
